...
public class Prontuario {
    ...
    public void serializar(Patient z, String doenca) {
        ...
        try {
            FileReader arquivo1 = new FileReader( "prontuarios/" + z.getNome() + "_" + z.getCPF() + ".txt");
            ...
            arquivo1.close();
            FileWriter arquivo2 = new FileWriter("prontuarios/" + z.getNome() + "_" + z.getCPF() + ".txt", true);
        ...
        //O bloco catch sera acionado caso aida nao exista um arquivo para o paciente
            ...
            try {
                FileWriter arquivo = new FileWriter("prontuarios/" + z.getNome() + "_" + z.getCPF() + ".txt");      //Um novo arquivo sera criado
    ...
    public void maisRecorrente(Patient z) {
        ...
        try {
            FileReader arquivo = new FileReader("prontuarios/" + z.getNome() + "_" + z.getCPF() + ".txt");
    ...
    public void print(Patient z) {
        try {
            ...
            FileReader arquivo = new FileReader("prontuarios/" + nomeZumbi + "_" + z.getCPF() + ".txt");
            BufferedReader formato = new BufferedReader(arquivo);
